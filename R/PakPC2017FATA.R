#' @title FATA Province data from Pakistan Population Census 2017 
#' @name   PakPC2017FATA
#' @docType data
#' @keywords datasets
#' @usage data(PakPC2017FATA)
#' @description \code{PakPC2017FATA} FATA Province data from Pakistan Population Census 2017.
#' @format A \code{data.table} and  \code{data.frame} with 26 obs. of  12 variables.
#' @details
#'        \itemize{
#'        \item Province Province of Pakistan
#'        \item Division Division of FATA Province of Pakitan
#'        \item District District of FATA Province of Pakitan
