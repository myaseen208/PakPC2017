...
#' @name   PakPC2017Balochistan
#' @docType data
#' @keywords datasets
#' @usage data(PakPC2017Balochistan)
#' @description \code{PakPC2017Balochistan} Balochistan Province data from Pakistan Population Census 2017.
#' @format A \code{data.table} and  \code{data.frame} with 64 obs. of  12 variables.
#' \describe{
