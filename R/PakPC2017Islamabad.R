...
#' @docType data
#' @keywords datasets
#' @usage data(PakPC2017Islamabad)
#' @description \code{PakPC2017Islamabad} Islamabad data from Pakistan Population Census 2017.
#' @format A \code{data.table} and  \code{data.frame} with 2 obs. of  12 variables.
#' @details
#'        \itemize{
#'        \item Province Province of Pakistan
#'        \item Division Division of Islamabad Province of Pakitan
#'        \item District District of Islamabad Province of Pakitan
