#' @title Sindh Province data from Pakistan Population Census 2017 
#' @name   PakPC2017Sindh
#' @docType data
#' @keywords datasets
#' @usage data(PakPC2017Sindh)
#' @description \code{PakPC2017Sindh} Sindh Province data from Pakistan Population Census 2017.
#' @format A \code{data.table} and  \code{data.frame} with 58 obs. of  12 variables.
#' @details
#'        \itemize{
#'        \item Province Province of Pakistan
#'        \item Division Division of Sindh Province of Pakitan
#'        \item District District of Sindh Province of Pakitan
