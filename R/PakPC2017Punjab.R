#' @title Punjab Province data from Pakistan Population Census 2017
#' @name   PakPC2017Punjab
#' @docType data
#' @keywords datasets
#' @usage data(PakPC2017Punjab)
#' @description \code{PakPC2017Punjab} Punjab Province data from Pakistan Population Census 2017.
